module switchboard::service_queue_add_mr_enclave_action {
    ...
    public fun validate<CoinType>(
        ...
        assert!(!service_queue::has_mr_enclave(service_queue, mr_enclave), errors::MrEnclaveAlreadyExists());
    }
    ...
    fun actuate<CoinType>(
        ...
        service_queue::add_mr_enclave(service_queue, mr_enclave);
    }
