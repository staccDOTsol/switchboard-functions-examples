...
use crate::ecvrf::curve25519_dalek_onchain::constants::{
    APLUS2_OVER_FOUR, MONTGOMERY_A, MONTGOMERY_A_NEG,
};
...
impl MontgomeryPoint {
    ...
    pub fn to_edwards(&self, sign: u8) -> Option<EdwardsPoint> {
        ...
        let y = CompressedEdwardsY(y_bytes);
        let (a, b, c) = y.decompress_init();
        y.decompress_fini(a, b, c)
    }
}
...
pub(crate) fn elligator_encode(r_0: &FieldElement) -> MontgomeryPoint {
    ...
    let (t3, t13, t15) = FieldElement::sqrt_ratio_i_p1(&eps, &one);
    // TODO: mgild double check.
    let (eps_is_sq, _eps) = FieldElement::sqrt_ratio_i_p2(&eps, &one, &t13, &t15);
