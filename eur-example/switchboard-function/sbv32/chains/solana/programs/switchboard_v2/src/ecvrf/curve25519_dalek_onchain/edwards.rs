...
use crate::ecvrf::curve25519_dalek_onchain::montgomery::MontgomeryPoint;

use crate::ecvrf::curve25519_dalek_onchain::backend::serial::curve_models::AffineNielsPoint;
...
use crate::ecvrf::curve25519_dalek_onchain::window::LookupTableRadix16;
// use crate::ecvrf::curve25519_dalek_onchain::window::LookupTableRadix32;
// use crate::ecvrf::curve25519_dalek_onchain::window::LookupTableRadix64;
// use crate::ecvrf::curve25519_dalek_onchain::window::LookupTableRadix128;
// use crate::ecvrf::curve25519_dalek_onchain::window::LookupTableRadix256;
use crate::ecvrf::curve25519_dalek_onchain::backend::serial::scalar_mul;

#[allow(unused_imports)]
use super::prelude::*;

use crate::ecvrf::curve25519_dalek_onchain::traits::BasepointTable;
use crate::ecvrf::curve25519_dalek_onchain::traits::ValidityCheck;
use crate::ecvrf::curve25519_dalek_onchain::traits::{Identity, IsIdentity};

use crate::CompletedPoint;
use crate::EdwardsPoint;

#[cfg(any(feature = "alloc", feature = "std"))]
use super::traits::MultiscalarMul;
#[cfg(any(feature = "alloc", feature = "std"))]
use super::traits::{VartimeMultiscalarMul, VartimePrecomputedMultiscalarMul};

#[cfg(all(
    feature = "simd_backend",
    any(target_feature = "avx2", target_feature = "avx512ifma")
))]
use crate::ecvrf::curve25519_dalek_onchain::backend::vector::scalar_mul;
...
impl CompressedEdwardsY {
    ...
    /// curve point.
    pub fn decompress_init(&self) -> (FieldElement, FieldElement, FieldElement) {
        let Y = FieldElement::from_bytes(self.as_bytes());
        let Z = FieldElement::one();
        let YY = Y.square();
        let u = &YY - &Z; // u =  y²-1
        let v = &(&YY * &constants::EDWARDS_D) + &Z; // v = dy²+1
        FieldElement::sqrt_ratio_i_p1(&u, &v)
    }
    ...
    pub fn decompress_fini(
        ...
        let u = &YY - &Z; // u =  y²-1
        let v = &(&YY * &constants::EDWARDS_D) + &Z; // v = dy²+1
        let (is_valid_y_coord, mut X) = FieldElement::sqrt_ratio_i_p2(&u, &v, &y, &z);
...
impl EdwardsPoint {
        ...
        D: Digest<OutputSize = U64> + Default,
    {
        ...
        let M1 = crate::ecvrf::curve25519_dalek_onchain::montgomery::elligator_encode(&fe);
...
impl<'a, 'b, 'c> EdwardsPoint {
    ...
    fn mul(
        round: usize,
        tmp1: CompletedPoint,
        point: &'a EdwardsPoint,
        scalar: &'b Scalar,
    ) -> (CompletedPoint, ProjectivePoint, EdwardsPoint) {
        // msg!("blah");
        scalar_mul::variable_base::mul(round, tmp1, point, scalar)
    }
}
...
// );
//
// use crate::ecvrf::curve25519_dalek_onchain::traits::VartimeMultiscalarMul;
