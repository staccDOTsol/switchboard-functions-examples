...
exports.SwapInstruction =
  exports.SwapInstructionLayout =
...
exports.STABLE_SWAP_N_POOL_PROGRAM_ID = new web3_js_1.PublicKey(
...
const swapInstructions = [
  ...
  (0, borsh_1.struct)(
    [
      (0, borsh_1.vec)((0, borsh_1.u64)(), "depositAmounts"),
      (0, borsh_1.u64)("minMintAmount"),
    ],
    "addLiquidity"
  ),
  (0, borsh_1.struct)(
    [
      (0, borsh_1.u64)("unmintAmount"),
      (0, borsh_1.vec)((0, borsh_1.u64)(), "minimumAmounts"),
    ],
    "removeLiquidity"
  ),
  (0, borsh_1.struct)(
    [(0, borsh_1.u64)("unmintAmount"), (0, borsh_1.u64)("minimumOutAmount")],
    "removeLiquidityOneToken"
  ),
  (0, borsh_1.struct)(
    [(0, borsh_1.u64)("inAmount"), (0, borsh_1.u64)("minimumOutAmount")],
    "exchange"
  ),
    ...
    return new web3_js_1.TransactionInstruction({
      ...
      data: encodeSwapInstructionData({
        initialize: {
          ...
          amplificationCoefficient: new bn_js_1.default(
            amplificationCoefficient
          ),
