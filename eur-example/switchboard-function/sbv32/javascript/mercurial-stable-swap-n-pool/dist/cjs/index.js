...
exports.findLogAndParseWithRegex =
  exports.findLogAndParse =
  exports.StableSwapNPool =
  exports.FEE_DENOMINATOR =
  exports.SIMULATION_USER =
  exports.STABLE_SWAP_N_POOL_PROGRAM_ID =
    void 0;
...
Object.defineProperty(exports, "STABLE_SWAP_N_POOL_PROGRAM_ID", {
  enumerable: true,
  get: function () {
    return instructions_2.STABLE_SWAP_N_POOL_PROGRAM_ID;
  },
});
exports.SIMULATION_USER = new web3_js_2.PublicKey(
...
bn_js_1.default.prototype.toBuffer = function () {
...
class StableSwapNPool {
  ...
  static getMinBalanceRentForExemptSwapState(connection) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield connection.getMinimumBalanceForRentExemption(
        state_1.SwapState.span
      );
    });
  }
  /**
  ...
  static create(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const instructions = [
        ...
        instructions_1.SwapInstruction.initialize(
  ...
  static getTokenMints(connection, address) {
    return __awaiter(this, void 0, void 0, function* () {
      const data = yield (0, loadAccount_1.loadAccount)(
        connection,
        address,
        instructions_1.STABLE_SWAP_N_POOL_PROGRAM_ID
      );
  ...
  static loadWithData(poolAddress, poolData, authority) {
    const swapState = state_1.SwapState.decode(poolData);
    if (!swapState.isInitialized) {
      throw new Error(`Invalid vault state`);
    }
    // Hand manipulation of the underlying vec
  ...
  static load(connection, address, simulationUser, cache = true) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const [authority] = yield web3_js_2.PublicKey.findProgramAddress(
        [address.toBuffer()],
        instructions_1.STABLE_SWAP_N_POOL_PROGRAM_ID
      );
      return new StableSwapNPool(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      instructions = instructions.concat([
        ...userSourceTokenAccounts.map((userSourceTokenAccount, i) =>
          spl_token_1.Token.createApproveInstruction(
        ...
        instructions_1.SwapInstruction.addLiquidity(
          this.poolAccount,
          this.authority,
          ephemeralKeypair.publicKey,
          this.tokenAccounts,
        ...
        ...userSourceTokenAccounts.map((userSourceTokenAccount) =>
          spl_token_1.Token.createRevokeInstruction(
            spl_token_1.TOKEN_PROGRAM_ID,
            userSourceTokenAccount,
            sender.userPublicKey,
            []
  ...
  removeLiquidity(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      instructions = instructions.concat([
        ...
        instructions_1.SwapInstruction.removeLiquidity(
          this.poolAccount,
          this.authority,
          ephemeralKeypair.publicKey,
          this.tokenAccounts,
  ...
  removeLiquidityOneToken(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      instructions = instructions.concat([
        ...
        instructions_1.SwapInstruction.removeLiquidityOneToken(
          this.poolAccount,
          this.authority,
          ephemeralKeypair.publicKey,
          this.tokenAccounts,
  ...
  getOutAmount(sourceTokenMint, destinationTokenMint, inAmount) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const instructions = [
        ...
        spl_token_1.Token.createInitAccountInstruction(
          spl_token_1.TOKEN_PROGRAM_ID,
          sourceTokenMint,
          kp1.publicKey,
          this.simulationUser
      ...
      const { value } = yield this.connection.simulateTransaction(
        new web3_js_1.Transaction({ feePayer: this.simulationUser }).add(
          ...instructions
        )
      );
      const result = findLogAndParse(
  ...
  getVirtualPrice() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const instructions = [
        instructions_1.SwapInstruction.getVirtualPrice(
          this.poolAccount,
          this.authority,
          this.simulationUser,
          this.tokenAccounts,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      if (payer) {
        ...
        const signature = yield connection.sendTransaction(
          new web3_js_1.Transaction().add(transferIx),
          [payer],
          {
            skipPreflight: true,
          }
        ...
        const tokenLP = new spl_token_1.Token(
          connection,
          poolTokenMint,
          spl_token_1.TOKEN_PROGRAM_ID,
          payer
        ...
        return {
          tokenAccounts: yield Promise.all(
            tokenMints.map((tokenMint) =>
              spl_token_1.Token.getAssociatedTokenAddress(
          ...
          tokenAccountLP: yield spl_token_1.Token.getAssociatedTokenAddress(
            spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID,
            spl_token_1.TOKEN_PROGRAM_ID,
            poolTokenMint,
            simulationUser
  ...
  static getTokenAccountMint(connection, publicKey, cache = false) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      if (cache) {
        const allTokenMints = token_mints_json_1.default;
        const tokenMint = allTokenMints[publicKey.toBase58()];
        if (tokenMint) {
          return new web3_js_2.PublicKey(tokenMint);
        }
      }
      ...
      return new web3_js_2.PublicKey(
        spl_token_1.AccountLayout.decode(accountInfoData).mint
      );
    });
  }
...
function findLogAndParseWithRegex(logs, re) {
  let result;
  logs === null || logs === void 0
    ? void 0
    : logs.find((log) => {
        ...
        if (
          ...
          result = new bn_js_1.default(match[1]);
        }
        return match;
      });
  if (!result) {
...
exports.findLogAndParseWithRegex = findLogAndParseWithRegex;
function getSimulateSwapInstructions(
  hgPool,
  inKey,
  outKey,
  simulationUser,
...
exports.getSimulateSwapInstructions = getSimulateSwapInstructions;
