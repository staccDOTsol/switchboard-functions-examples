...
export interface ReceiverExampleInterface extends utils.Interface {
  functions: {
    ...
    "getLatestTrigger()": FunctionFragment;
    "randomValue()": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic: "callback" | "getLatestTrigger" | "randomValue"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getLatestTrigger",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ReceiverExample extends BaseContract {
  ...
  functions: {
    ...
    getLatestTrigger(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    getLatestTrigger(overrides?: CallOverrides): Promise<PopulatedTransaction>;
