...
export function prettyPrintFunction(
  ...
  const requestsDisabled = functionState.requestsDisabled
    ? "Disabled"
    : "Enabled";
  output.push(chalkString("allowRequests", requestsDisabled, SPACING));
  output.push(
    chalkString("allowRoutines", functionState.routinesDisabled.kind, SPACING)
  );
