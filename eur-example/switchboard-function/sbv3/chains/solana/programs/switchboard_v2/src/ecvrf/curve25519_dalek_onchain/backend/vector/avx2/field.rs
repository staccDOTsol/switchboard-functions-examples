...
use crate::ecvrf::curve25519_dalek_onchain::backend::serial::u64::field::FieldElement51;
use crate::ecvrf::curve25519_dalek_onchain::backend::vector::avx2::constants::{
...
impl FieldElement2625x4 {
    ...
    pub fn square_and_negate_D(&self) -> FieldElement2625x4 {
        ...
        let mut z0 = m(x0, x0)
            + m(x2_2, x8_19)
            + m(x4_2, x6_19)
            + ((m(x1_2, x9_19) + m(x3_2, x7_19) + m(x5, x5_19)) << 1);
        let mut z1 =
            m(x0_2, x1) + m(x3_2, x8_19) + m(x5_2, x6_19) + ((m(x2, x9_19) + m(x4, x7_19)) << 1);
        let mut z2 = m(x0_2, x2)
            + m(x1_2, x1)
            + m(x4_2, x8_19)
            + m(x6, x6_19)
            + ((m(x3_2, x9_19) + m(x5_2, x7_19)) << 1);
        let mut z3 =
            m(x0_2, x3) + m(x1_2, x2) + m(x5_2, x8_19) + ((m(x4, x9_19) + m(x6, x7_19)) << 1);
        let mut z4 = m(x0_2, x4)
            + m(x1_2, x3_2)
            + m(x2, x2)
            + m(x6_2, x8_19)
            + ((m(x5_2, x9_19) + m(x7, x7_19)) << 1);
        let mut z5 =
            m(x0_2, x5) + m(x1_2, x4) + m(x2_2, x3) + m(x7_2, x8_19) + ((m(x6, x9_19)) << 1);
