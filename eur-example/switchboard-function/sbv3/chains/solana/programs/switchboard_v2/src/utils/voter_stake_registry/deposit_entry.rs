use crate::utils::voter_stake_registry::lockup::{Lockup, LockupKind};
use crate::utils::voter_stake_registry::voting_mint_config::VotingMintConfig;
...
mod tests {
    use super::*;
    use crate::utils::LockupKind::{Constant, Daily};
